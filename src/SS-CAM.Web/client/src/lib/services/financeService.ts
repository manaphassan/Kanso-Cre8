...
export const SAMPLE_INVOICES: InvoiceDocument[] = [
  {
    ...
    status: 'sent',
    clientCode: 'GOV',
    clientName: 'Govicle Sdn Bhd',
    clientContact: 'Amirul Haziq',
    clientEmail: 'amirul@govicle.my',
    clientAddress: 'Level 15, Menara Govicle, Bangsar South, 59200 Kuala Lumpur',
    ...
    items: [
      {
        id: '1',
        description: '50% Project Deposit: Fleet Management 3D Isometric Illustrations (3 Sets)',
        quantity: 1,
        unitPrice: 1750,
        amount: 1750
      },
      {
        id: '2',
        description: 'Design System Asset Kit & Custom SVG Icon Pack',
        quantity: 1,
        unitPrice: 500,
        amount: 500
      }
    ...
    taxAmount: 0,
    total: 2250,
    notes: 'Payment is due within 14 days of invoice date via direct bank transfer. Thank you for your business!',
    linkedProjectId: '202609_0001_GOV_FleetApp'
  },
  {
    id: 'inv-2026-002',
    type: 'invoice',
    ...
    status: 'paid',
    clientCode: 'JOM',
    clientName: 'Jomparking Technologies',
    clientContact: 'Stephanie Wong',
    clientEmail: 'steph@jomparking.com',
    clientAddress: 'Q Sentral, KL Sentral, 50470 Kuala Lumpur',
    freelancerName: 'Harussani Design Studio',
    freelancerEmail: 'harussani.design@gmail.com',
    freelancerPhone: '+60 19-876 5432',
    freelancerAddress: 'Kuala Lumpur, Malaysia',
    ...
    items: [
      {
        id: '1',
        description: 'Social Media Promo Video Motion Graphics (9:16 Reel + 1:1 Feed)',
        quantity: 1,
        unitPrice: 2200,
        amount: 2200
      }
    ...
    linkedProjectId: '202609_0002_JOM_SmartParkingPromo'
  }
];
