...
class AppStateStore {
  ...
  private static readonly VALID_THEMES: ThemeName[] = ['dark', 'light', 'eink', 'oceanic', 'oceanic-light', 'neumorphic', 'neumorphic-dark', 'falconia', 'metamorphosis', 'catppuccin'];
  ...
  cycleTheme() {
    const sequence: ThemeName[] = ['dark', 'light', 'oceanic', 'oceanic-light', 'neumorphic', 'neumorphic-dark', 'eink'];
  ...
  applyTheme(themeName: ThemeName) {
    if (typeof document !== 'undefined') {
      ...
      if (themeName === 'dark' || themeName === 'oceanic' || themeName === 'neumorphic-dark') {
